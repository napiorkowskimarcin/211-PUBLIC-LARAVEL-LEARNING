        ...
        @csrf
            ...
            <div class="mb-4">
             ...
             <div class="mb-4">
                ...
                <input type="text" name="password" id="password" placeholder="Choose a password" class="bg-gray-100 border-2 w-full p-4 rounded-lg">
                @error('password')
                <div class="text-red-500 mt-2 text-sm">
                    {{$message}}
                </div>
             ...
             <div class="mb-4">
                ...
                <input type="text" name="password_confirmation" id="password_confirmation" placeholder="Repeat a password" class="bg-gray-100 border-2 w-full p-4 rounded-lg">
